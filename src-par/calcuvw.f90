...
! Local variables
!
  integer :: i, k, inp, ijp, ijn, iface, ipro
    ...
    do ib=1,numBoundaries
      ...
      if ( bctype(ib) == 'process' ) then
        ...
        do i=1,nfaces(ib)
          ...
          su(ijp) = su(ijp) - apr(ipro)*uo(ijn)

          ! This is relevant to next loop over cells
          su(ijp) = su(ijp) + apr(ipro)*uo(ijp)
    ...
    do ib=1,numBoundaries
      ...
      if ( bctype(ib) == 'process' ) then
        ...
        do i=1,nfaces(ib)
          ...
          ! This is relevant to previous loop over faces
          sv(ijp) = sv(ijp) - apr(ipro)*vo(ijn)

          ! This is relevant to next loop over cells
          sv(ijp) = sv(ijp) + apr(ipro)*vo(ijp)
    ...
    do ib=1,numBoundaries
      ...
      if ( bctype(ib) == 'process' ) then
        ...
        do i=1,nfaces(ib)
          ...
          ! This is relevant to previous loop over faces
          sw(ijp) = sw(ijp) - apr(ipro)*wo(ijn)

          ! This is relevant to next loop over cells
          sw(ijp) = sw(ijp) + apr(ipro)*wo(ijp)
