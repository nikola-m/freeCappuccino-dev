...
Transfinite Line {9,10,11,12} = numinner Using Bump 0.25;    // And 10 points along each of these lines
...
//+
//Transfinite Curve {9, 43, 12, 41, 10, 18, 20, 11} = 10 Using Bump 0.25;
