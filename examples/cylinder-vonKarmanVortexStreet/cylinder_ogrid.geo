...
radius = 0.5;
outer = 30; //outer radius
numinner = 60; //number of mesh segments
numcyl = 40; 
...
Transfinite Line {5,6,7,8,13,14,15,16} = numcyl; // We want 40 points along each of these lines
...
//+
Physical Surface("cylinder") = {55, 37, 73, 99};
//+
Physical Surface("front") = {2, 4, 1, 3};
//+
Physical Surface("back") = {60, 82, 104, 38};
//+
Physical Surface("Outlet") = {29, 91};
//+
Physical Surface("Inlet") = {47, 81};
//+
