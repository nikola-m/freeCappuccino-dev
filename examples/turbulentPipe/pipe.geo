...
//Points
// Inner Box
Point(1) = {0, -InnerBox,-InnerBox, gridsize};
Point(2) = {0, InnerBox, -InnerBox, gridsize};
Point(3) = {0, InnerBox, InnerBox, gridsize};
Point(4) = {0, -InnerBox, InnerBox, gridsize};

// Outer Ring
Point(5) = {0, -Radius*sqrtTwo, -Radius*sqrtTwo, gridsize};
Point(6) = {0, Radius*sqrtTwo, -Radius*sqrtTwo, gridsize};
Point(7) = {0, Radius*sqrtTwo, Radius*sqrtTwo, gridsize};
Point(8) = {0, -Radius*sqrtTwo, Radius*sqrtTwo, gridsize};
